            ...
            <div class="bg-gray-800/70 backdrop-blur-sm overflow-hidden shadow-lg rounded-2xl border border-gray-700">
                <div class="p-8 text-gray-100">
                    <div class="flex items-center gap-4 mb-8">
                        <a href="{{ route('category.index') }}" class="p-2 rounded-md text-gray-400 hover:bg-gray-700 transition">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400">Create a new product category</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('category.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4">
                            <a href="{{ route('category.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-300 bg-gray-900 border border-gray-700 rounded-lg hover:bg-gray-800 transition">
                                Cancel
                            </a>
