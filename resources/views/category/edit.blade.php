            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center gap-4 mb-8">
                        <a href="{{ route('category.index') }}" class="p-1.5 rounded-md text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Ubah nama kategori</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('category.update', $category) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $category->name) }}" placeholder="e.g. Elektronik"
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4">
                            <a href="{{ route('category.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                                Cancel
                            </a>
